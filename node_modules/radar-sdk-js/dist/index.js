...
var Events = /*#__PURE__*/function () {
  ...
  _createClass(Events, null, [{
    key: "logConversion",
    value: function () {
      var _logConversion = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var eventData,
            name,
            metadata,
            createdAt,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                name = eventData.name, metadata = eventData.metadata, createdAt = eventData.createdAt, revenue = eventData.revenue;
                deviceId = Device.getId();
                userId = Storage.getItem(Storage.USER_ID);
                installId = Storage.getItem(Storage.INSTALL_ID);
      ...
      function logConversion() {
        return _logConversion.apply(this, arguments);
      }
...
var Radar = /*#__PURE__*/function () {
  ...
  _createClass(Radar, null, [{
    ...
    key: "logConversion",
    value: function logConversion(eventData) {
      var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultCallback;
      Events.logConversion(eventData).then(function (response) {
        callback(null, {
