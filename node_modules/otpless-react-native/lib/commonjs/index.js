...
exports.OtplessModule = exports.OtplessEventModule = void 0;
var _reactNative = require("react-native");
const LINKING_ERROR = `The package 'otpless-react-native' doesn't seem to be linked. Make sure: \n\n` + _reactNative.Platform.select({
  ios: "- You have run 'pod install'\n",
  default: ''
}) + '- You rebuilt the app after installing the package\n' + '- You are not using Expo Go\n';
const OtplessReactNative = _reactNative.NativeModules.OtplessReactNative ? _reactNative.NativeModules.OtplessReactNative : new Proxy({}, {
  get() {
...
class OtplessEventModule extends OtplessBaseModule {
  constructor(callback) {
    super();
    this.eventEmitter = new _reactNative.NativeEventEmitter(OtplessReactNative);
...
exports.OtplessEventModule = OtplessEventModule;
...
exports.OtplessModule = OtplessModule;
